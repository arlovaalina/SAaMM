...
def initialize_window():
    ...
    a_value_label = Label(root, text = "Вероятность не выдачи заявки, ρ").place(x = 10, y = 10)
    a_value_input = Entry(root, width = 27)
    a_value_input.place(x = 10, y = 30)
    
    r_value_label = Label(root, text = "Вероятность просеивания, π1").place(x = 10, y = 60)
    r_value_input = Entry(root, width = 27)
    r_value_input.place(x = 10, y = 80)
    
    m_value_label = Label(root, text = "Вероятность просеивания, π2").place(x = 10, y = 110)
    m_value_input = Entry(root, width = 27)
    m_value_input.place(x = 10, y = 130)
    
    n_value_label = Label(root, text = "Количество тактов").place(x = 10, y = 160)
    n_value_input = Entry(root, width = 27)
